...
function! MessageRecall#MappingsAndCommands#MessageBufferSetup( messageStoreDirspec, range, whenRangeNoMatch, ignorePattern, subDirForUserProvidedDirspec, CompleteFuncref )
